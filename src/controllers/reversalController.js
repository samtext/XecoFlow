...
/**
 * Get all reversals (admin only - you can add auth later)
 */
export const getAllReversals = async (req, res) => {
    try {
        const { limit = 50, status } = req.query;
        
        console.log(`📊 [REVERSAL_LIST] Fetching recent reversals`);
        ...
        console.log(`✅ [REVERSAL_LIST] Found ${data.length} reversals`);
